...
return function(context)
    setfenv(1, context)
    contactFlingPanel=Instance.new("ScrollingFrame");contactFlingPanel.BorderSizePixel=0;contactFlingPanel.ScrollBarThickness=3;contactFlingPanel.ScrollingDirection=Enum.ScrollingDirection.Y;contactFlingPanel.AutomaticCanvasSize=Enum.AutomaticSize.Y;contactFlingPanel.CanvasSize=UDim2.new();contactFlingPanel.Active=true;contactFlingPanel.Name="ContactFlingPanel";contactFlingPanel.Size=UDim2.new(1,-16,1,-(titleH+20));contactFlingPanel.Position=UDim2.new(0,8,0,titleH+8);contactFlingPanel.BackgroundTransparency=1;contactFlingPanel.Visible=false;contactFlingPanel.ZIndex=6;contactFlingPanel.Parent=content
    ...
    local description=Instance.new("TextLabel");description.Size=UDim2.new(1,0,0,54);description.BackgroundTransparency=1;description.Text=isES and "Usa automáticamente un accesorio físico compatible para generar el impulso sin afectar el movimiento de tu personaje." or "Automatically uses a compatible physical accessory to produce the impulse without affecting your character movement.";description.TextColor3=currentTheme.textDim;description.Font=Enum.Font.GothamMedium;description.TextSize=isMobile and 11 or 13;description.TextWrapped=true;description.TextXAlignment=Enum.TextXAlignment.Left;description.TextYAlignment=Enum.TextYAlignment.Top;description.ZIndex=8;description.Parent=card;RegisterTheme(description,"TextColor3","textDim")
