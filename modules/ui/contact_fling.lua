...
return function(context)
    ...
    local description=Instance.new("TextLabel");description.Size=UDim2.new(1,0,0,54);description.BackgroundTransparency=1;description.Text=isES and "Puedes caminar normalmente. Al tocar otro personaje se genera una ráfaga física breve y vuelves inmediatamente a tu posición." or "Walk normally. Touching another character produces a brief physical burst and immediately restores your position.";description.TextColor3=currentTheme.textDim;description.Font=Enum.Font.GothamMedium;description.TextSize=isMobile and 11 or 13;description.TextWrapped=true;description.TextXAlignment=Enum.TextXAlignment.Left;description.TextYAlignment=Enum.TextYAlignment.Top;description.ZIndex=8;description.Parent=card;RegisterTheme(description,"TextColor3","textDim")
