...
local function _CleanupScript()
	...
	pcall(function() if VerticalControlController then VerticalControlController:Destroy() end end)
	pcall(function() if InverseVerticalController then InverseVerticalController:Destroy() end end)
	...
	pcall(function() if Fling2AutoController then Fling2AutoController:Stop() end end)
