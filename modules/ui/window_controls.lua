...
local function _CleanupScript()
	pcall(function() if FlingCore then FlingCore:Stop() end end)
	...
	pcall(function() if _flingPlayerRemovingConn then _flingPlayerRemovingConn:Disconnect() end end)
	pcall(function() if _flingCharacterAddedConn then _flingCharacterAddedConn:Disconnect() end end)
