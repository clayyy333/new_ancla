...
UpdateTabStyles = function()
	...
	local isInverseVertical = currentTab == "inverse_vertical_anchor"
	local isAnchor = isAnchorBasic or isAnchorAuto or isInverseVertical
...
UpdateTabData = function()
	...
	inverseVerticalPanel.Visible = isInverseVertical
	...
	elseif currentTab == "inverse_vertical_anchor" then
		title.Text = "Test 1"
		if UpdateInverseVerticalPanel then UpdateInverseVerticalPanel() end
	...
	elseif currentTab == "fling_object" then
		title.Text = isES and "Fling con objeto" or "Object Fling"
	...
	elseif currentTab == "movement_control" then
		title.Text = isES and "Control de velocidad" or "Speed Control"
		if UpdateMovementControlPanel then UpdateMovementControlPanel() end
	...
	elseif currentTab == "couples" then
		title.Text = isES and "Parejas" or "Couples"
		if UpdateCouplesPanel then UpdateCouplesPanel() end
...
anchorTabBtns["inverse_vertical_anchor"].btn.MouseButton1Click:Connect(function() currentTab = "inverse_vertical_anchor"; UpdateTabData() end)
