...
return function(context)
	setfenv(1,context)
	cameraControlPanel=Instance.new("Frame"); cameraControlPanel.Size=UDim2.new(1,-16,1,-(titleH+20)); cameraControlPanel.Position=UDim2.new(0,8,0,titleH+8); cameraControlPanel.BackgroundTransparency=1; cameraControlPanel.Visible=false; cameraControlPanel.ZIndex=6; cameraControlPanel.Parent=content
