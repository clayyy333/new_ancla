...
return function(context)
	...
	UpdateMotoFlingXenoPanel=function(message)
		...
		forceReturnButton.Active=not MotoFlingXenoCore.Busy
	...
	forceReturnButton.MouseButton1Click:Connect(function()
		task.spawn(function()
			local ok,err=MotoFlingXenoCore:ForceReturn()
			UpdateMotoFlingXenoPanel(ok and (isES and "Regreso forzado al checkpoint." or "Returned to checkpoint.") or err)
		end)
	end)
	UpdateMotoFlingXenoPanel()
	return true
