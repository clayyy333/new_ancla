...
return function(context)
	...
	card.Size=UDim2.new(1,0,0,isMobile and 214 or 230)
	...
	UpdateAnchorPanel=function(message)
		...
		local manualEnabled=not (AutoAnchorCore and (AutoAnchorCore.Mode or AutoAnchorCore.Busy))
		anchorButton.Active=manualEnabled
		antiSeatButton.Active=manualEnabled
		heartbeatButton.Active=manualEnabled
		description.Text=message or (AnchorCore.HeartbeatEnabled and not AnchorCore.AnclaEnabled
